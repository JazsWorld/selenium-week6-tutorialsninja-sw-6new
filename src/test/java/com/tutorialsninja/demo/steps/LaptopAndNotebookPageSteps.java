...
public class LaptopAndNotebookPageSteps {
    ...
    public void iFilledAllMandatoryFieldOfCheckoutPage() {
        new CheckoutPage().enterFirstName("vishal");
        new CheckoutPage().enterLastName("Patel");
        new CheckoutPage().enterEmailId("vish");
        new CheckoutPage().enterTelephone("01234567890");
        new CheckoutPage().enterAddressLine1("37 southwell drive");
        new CheckoutPage().enterCity("rugby");
        new CheckoutPage().enterPostCode("cv23 1by");
